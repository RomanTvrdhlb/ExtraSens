    ...
    for (var c = na(a.m()), d = 0; d < c.length; d++) {
      ...
      if (p(b, f)) {
        ...
        if (e.l) {
          ...
          (e = u(b, f)),
            g ? ((g = u(a, f)) ? pa(g, e) : r(a, f, e.clone())) : r(a, f, e);
      }
    }
  }
...
*/
  ...
  function O(a, b) {
    for (var c = new B(), d, e = a.length, f = 0; f < e; ++f)
  ...
  function W(a, b, c, d) {
    ...
    if (2 == d)
      if (Pa(U(c, 0)))
        (a = U(c, 1)),
          Pa(a) &&
            ((f = f.concat(0 == w(a, 9) ? t(q(c, 1), 9) : t(a, 9))),
            f.sort(),
            0 == e.length
              ? (e = t(a, 10))
              : ((e = e.concat(t(a, 10))), e.sort()));
  ...
  function Za(a, b, c, d) {
    ...
    try {
      ...
      if ("Invalid country calling code" == ba.message && L.test(l)) {
        if (((l = l.replace(L, "")), (h = Xa(a, l, g, b, d, f)), 0 == h))
          throw ba;
      } else throw ba;
    }
    0 != h
    ...
    null != g &&
      ...
      2 != a &&
        4 != a &&
        5 != a &&
        ((b = e), d && 0 < c.toString().length && r(f, 7, c.toString())));
    d = b.toString();
    a = d.length;
    if (2 > a)
      throw Error("The string supplied is too short to be a phone number");
  ...
  function nb(a) {
    for (var b = a.g.toString(), c = a.j.length, d = 0; d < c; ++d) {
      ...
      if (
        new RegExp("^(?:" + f + ")$").test(b) &&
        ((a.ha = db.test(q(e, 4))),
        (e = b.replace(new RegExp(f, "g"), q(e, 2))),
        (e = Z(a, e)),
        O(e, xa) == a.ba)
      )
        return e;
  ...
  function lb(a) {
    ...
    if (3 <= b.length) {
      for (
        ...
        var f = c[e];
        (0 < a.o.length && Qa(v(f, 4)) && !q(f, 6) && !p(f, 5)) ||
          ((0 != a.o.length || a.ca || Qa(v(f, 4)) || q(f, 6)) &&
            cb.test(v(f, 2)) &&
            a.j.push(f));
      }
      fb(a, b);
  ...
  k("intlTelInputUtils.formatNumberAsYouType", (a, b) => {
    try {
      ...
      for (let f = 0; f < c.length; f++)
        (b = d), (b.ja = gb(b, c.charAt(f))), (e = b.ja);
      return e;
    } catch (c) {
      return a;
    }
